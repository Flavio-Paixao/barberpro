        ...
        <div class="booking-card" id="bookingForm">
          ...
          <div class="form-group">
            ...
            <select class="form-select" id="barbeiroId" onchange="carregarHorarios()">
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $barbeiros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barbeiro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($barbeiro->id); ?>"><?php echo e($barbeiro->nome); ?><?php echo e($barbeiro->especialidade ? ' — ' . $barbeiro->especialidade : ''); ?></option>
          ...
          <div class="form-group">
            ...
            <select class="form-select" id="servicoId" onchange="carregarHorarios()">
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $servicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($servico->id); ?>"><?php echo e($servico->nome); ?> — R$<?php echo e(number_format($servico->preco, 2, ',', '.')); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </select>
          </div>
          <div class="form-group">
            <label class="form-label">Data</label>
            <input class="form-input" type="date" id="data" onchange="carregarHorarios()" min="<?php echo e(date('Y-m-d')); ?>"/>
          </div>
          <div class="form-group">
...
<footer>
  <div class="container">
    <div class="footer-inner">
      ...
      <span style="font-size:11px;color:var(--muted)">Desenvolvido por <span style="color:var(--blue-light)">Flávio Paixão</span></span>
  ...
  async function confirmarAgendamento() {
    ...
    try {
      ...
      if (result.sucesso) {
        ...
        document.getElementById('successDesc').innerHTML = `Olá <strong>${nome}</strong>!<br><br>Seu agendamento foi realizado com sucesso.<br>Você receberá uma confirmação no WhatsApp em breve.<br><br><strong>Data:</strong> ${data}<br><strong>Horário:</strong> ${horarioSelecionado}`;
      } else {
...
<?php /**PATH /var/www/barberpro/barberpro/resources/views/agendamento.blade.php ENDPATH**/ ?>