...
<main class="main">
  <div class="topbar">
    <div>
<div class="topbar-title"><span class="glitch" data-text="PROFISSIONALS">BARBEI<span style="color:var(--gold)">ROS</span></span></div>      <div class="topbar-sub">// Gestão da equipe</div>
    </div>
      ...
      <div class="barber-card">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          <div style="background:var(--surface);padding:10px;text-align:center;border-radius:4px">
            <div style="font-family:'Bebas Neue';font-size:20px;color:var(--gold)">{{ $b->agendamentos_count }}</div>
