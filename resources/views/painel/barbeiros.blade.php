...
<head>
  ...
  <title>BarberPro — Barbeiros</title>
  <style>
...
<main class="main">
  <div class="topbar">
    <div>
<div class="topbar-title"><span class="glitch" data-text="BARBEIROS">BARBEI<span style="color:var(--red)">ROS</span></span></div>      <div class="topbar-sub">// Gestão da equipe</div>
    </div>
